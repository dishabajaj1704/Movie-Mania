...
export const Header = () => {
  ...
  const activeClasses =
    "block py-2 px-3 text-primary-800 hover:text-primary-1000 rounded";
  const inactiveClasses = "block py-2 px-3 text-white hover:text-primary-800";
  ...
  const darkModeIcon = (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
      <path
        ...
        className="fill-primary-800 group-hover:fill-white"
      ></path>
      <path
  ...
  function handleSubmit(evt) {
    ...
    naviagte(`/movies/search?q=${queryTerm}`);
    evt.target.reset();
  }
  return (
    <nav className="bg-slate-900 fixed w-full z-20 top-0 start-0 border-b border-gray-700 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <img src={Logo} alt="film fiesta logo" className="h-12" />
        </Link>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <button
            type="button"
            className="text-white focus:outline-none font-medium rounded-lg px-2.5 py-1 bg-white hover:bg-primary-800 group dark:bg-primary-800 dark:hover:bg-white"
          ...
          <div className="relative hidden md:block">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
              <svg
                className="w-4 h-4 text-gray-500 dark:text-gray-400 ms-2"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 20 20"
            ...
            <form onSubmit={handleSubmit}>
              <input
                ...
                id="search-navbar"
                name="search"
                className="ms-2 block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
              />
            </form>
          </div>
