...
export const DetailSkeleton = () => {
  return (
    <div className="flex justify-around flex-wrap py-5 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
      <div className="max-w-sm">
        <svg
          class="w-[382px] h-[573px] text-gray-200 dark:text-gray-600"
          aria-hidden="true"
      ...
      <div className="max-w-2xl text-slate-800 dark:text-slate-50 max-md:px-5">
        ...
        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[500px] mb-4"></div>
        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[500px] mb-4"></div>
        <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-[500px] mb-4"></div>
